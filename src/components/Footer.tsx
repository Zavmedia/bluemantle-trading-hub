        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <a
              ...
              className="group inline-flex items-center justify-center h-[4em] w-[15em] rounded-[40px] bg-white cursor-pointer border-none no-underline"
            >
              <span className="inline-flex items-center justify-center bg-black h-[3em] w-[11.5em] rounded-[25px] text-white text-lg tracking-[3px] transition-all duration-500 group-hover:w-0 group-hover:overflow-hidden whitespace-nowrap">
                SHARE
              </span>
              <span className="flex items-center justify-center w-0 -mt-[3em] relative transition-all duration-400 group-hover:w-full group-hover:mt-0 overflow-hidden">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="mx-2 text-black fill-current">
