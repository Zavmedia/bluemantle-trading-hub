      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center gap-3">
            <motion.img src={logo} alt="Bluemantle Institute" className="h-14 w-14 object-contain" whileHover={{
            rotate: 360,
            scale: 1.1
          }} transition={{
            duration: 0.6
            ...
            <div className="hidden sm:block">
              <motion.h1 className="text-xl font-bold text-gradient-cyan" initial={{
              opacity: 0,
              x: -20
            }} animate={{
              opacity: 1,
              ...
              duration: 0.5,
              delay: 0.1
            }} className="text-xs text-muted-foreground my-0 mx-px">INSTITUTE OF TECHNOLOGY                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             </motion.p>
            </div>
          </Link>
