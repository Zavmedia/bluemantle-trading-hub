...
const Home = () => {
  ...
  const features = [
    { icon: Target, title: "Quality Learning", desc: "Structured curriculum for all levels" },
    { icon: Users, title: "Expert Guidance", desc: "NISM certified mentors" },
    { icon: Calendar, title: "Flexible Batches", desc: "Learn at your own pace" },
    { icon: Zap, title: "Live Training", desc: "Real-time market sessions" },
    { icon: BookOpen, title: "No Prerequisites", desc: "Start from scratch" },
  ];
          ...
          <div className="max-w-3xl">
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 mb-12">
                <Button 
                  size="lg" 
                  className="bg-gradient-cyan text-navy font-bold text-lg px-8 hover:opacity-90 glow-cyan"
                >
                  Explore Courses
                </Button>
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="border-secondary text-secondary hover:bg-secondary hover:text-navy font-semibold text-lg px-8"
                >
                  Join Free Webinar
                </Button>
              </div>
